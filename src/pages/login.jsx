...
const Login = () => {
  ...
  const { setUser, backendHealth } = useContext(AppContext);
      ...
      >
        ...
        >
            ...
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <input
                  ...
                  } placeholder-gray-500 text-gray-900 rounded-lg focus:outline-none focus:ring-primary-500 focus:border-primary-500 transition-colors`}
          ...
          <div>
            <button
              type="submit"
              disabled={isLoading || !backendHealth.isHealthy}
            ...
            <div>
              ...
              <div className="mt-6">
                <button
                  ...
                  disabled={!backendHealth.isHealthy}
